...
// Prelude
// -----------------------------------------------------------------------------
const REPETITIONS: u32 = 10; // number of repetitions when running tests
...
mod tests {
    ...
    fn test_01() {
        ...
        test_day!(results, 1031, 1080);
    }
    #[test]
    fn test_02() {
        let results = day02::run();
        test_day!(results, 58975, 308);
    }
